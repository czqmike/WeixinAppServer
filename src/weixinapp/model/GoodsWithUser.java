...
public class GoodsWithUser{
	...
	public GoodsWithUser() {
		super();
	}


	// 用包含商品类型信息的Goods构造 包含发布者信息的GoodsWithUser实体
	public GoodsWithUser(Goods good, String user_name, String weixin_no) {
	...
	public GoodsWithUser(Goods good, User user) {
		this.good_id = good.getGood_id();
		this.user_id = good.getUser_id();
		this.good_name = good.getGood_name();
		this.good_detail = good.getGood_detail();
		...
		this.counseling_time_map = good.getCounseling_time_map();
